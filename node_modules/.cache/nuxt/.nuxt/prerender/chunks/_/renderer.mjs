import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://E:/AAA1/CampusHub-website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file://E:/AAA1/CampusHub-website/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, decodePath, joinURL } from 'file://E:/AAA1/CampusHub-website/node_modules/ufo/dist/index.mjs';
import destr from 'file://E:/AAA1/CampusHub-website/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://E:/AAA1/CampusHub-website/node_modules/vue/server-renderer/index.mjs';
import { a as useRuntimeConfig, b as useStorage, d as defineRenderHandler, g as getRouteRules, u as useNitroApp } from './nitro.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://E:/AAA1/CampusHub-website/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://E:/AAA1/CampusHub-website/node_modules/devalue/index.js';
import { walkResolver } from 'file://E:/AAA1/CampusHub-website/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file://E:/AAA1/CampusHub-website/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"charset":"UTF-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0"},{"name":"description","content":"一套代码，多端覆盖。专为高校学子打造的一站式服务平台。"}],"link":[{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css"},{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"CampusHub - 开启智慧校园新生活"};
