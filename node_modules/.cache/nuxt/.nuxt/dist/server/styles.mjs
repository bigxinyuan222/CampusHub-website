...
export default {
  "app.vue": () => import('./_nuxt/app-styles.CCn2-jXX.mjs').then(interopDefault),
  "app.vue?vue&type=style&index=0&scoped=479b6cb9&lang.css": () => import('./_nuxt/app-styles.CCn2-jXX.mjs').then(interopDefault),
